...
(function () {
  function initGallery(gallery) {
    ...
    '<button type="button" class="yw-gallery-btn yw-gallery-prev" aria-label="Previous image"><svg width="20" height="10" viewBox="0 0 20 10" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M7.45677 10C7.09774 9.17355 6.72491 8.44353 6.33826 7.80992C5.95161 7.14876 5.56496 6.58402 5.17832 6.1157H20V3.8843H5.17832C5.56496 3.38843 5.95161 2.82369 6.33826 2.19008C6.72491 1.52893 7.09774 0.798898 7.45677 0H5.50973C3.76981 2.01102 1.93324 3.49862 0 4.46281V5.53719C1.93324 6.47383 3.76981 7.96143 5.50973 10H7.45677Z" fill="#FFF9EF" /></svg></button>' +
